...
import PatientsUploadRecord from "./components/PatientsUploadRecord";
import ViewPatientByDoctor from "./components/ViewPatientByDoctor";
// import PatientRevokePermission from "./components/PatientRevokePermission";
import CreatePrescriptionByDoctor from "./components/CreatePrescriptionByDoctor";
import PatientPresciption from "./components/PatientPresciption";
  ...
  return (
    <BrowserRouter>
      ...
      <Route path="/AboutPage" element={<AboutUs></AboutUs>}></Route>
        ...
        ></Route>
        <Route
          path="/patient/:hhNumber/patientgrantpermission"
          element={<PatientGrantPermission />}
        ></Route>
        <Route
          path="/patient/:hhNumber/patientsuploadrecord"
          element={<PatientsUploadRecord />}
        ></Route>
        <Route
          path="/patient/:hhNumber/patientpresciption"
          element={<PatientPresciption />}
        ></Route>
        ...
        <Route path="/doctor/:hhNumber/viewpatientbydoctor" element={<ViewPatientByDoctor/>} >
        </Route>
        <Route
          path="/doctor/:hhNumber/createprescription"
          element={<CreatePrescriptionByDoctor />}
        ></Route>
