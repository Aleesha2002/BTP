...
const PatientDashBoard = () => {
  ...
  const grantpermission = () =>
    navigate(`/patient/${hhNumber}/patientgrantpermission`);
  const uploadrecord = () =>
    navigate(`/patient/${hhNumber}/patientsuploadrecord`);
  const patientpresciption = () =>
    navigate(`/patient/${hhNumber}/patientpresciption`);
